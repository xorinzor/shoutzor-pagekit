<div class="uk-text-center uk-width-1-1">
    <img src="<?= $view->url()->getStatic('theme:images/shoutzor-logo-small.png'); ?>" class="uk-margin-large-bottom uk-margin-large-top" />

    <form class="uk-panel uk-panel-box pk-user pk-user-login uk-form uk-form-stacked uk-width-small-1-2 uk-width-medium-1-2 uk-width-large-1-3 uk-container-center" action="<?= $view->url('@user/authenticate') ?>" method="post">
